...
import org.openapitools.model.XRechnungResponse
...
class GenerateXrechnungApi {
    ...
    def generateXrechnungApi ( String id, String supplierName, String supplierStreet, String supplierCity, String supplierZip, String supplierCountry, String supplierVatId, Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/api/v1/invoices/${id}/xrechnung"
